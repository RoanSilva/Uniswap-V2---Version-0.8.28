...
/**
 * @title ERC20
 * @notice Um token ERC-20 padrão com suporte a aprovações off-chain via EIP-2612.
 * @dev Implementa o padrão ERC-20 com funções de transferência, aprovação e queima, além de suporte a permits (EIP-2612).
...
contract ERC20 {
    ...
    constructor(uint256 _totalSupply) {
        require(_totalSupply > 0, "ERC20: INVALID_INITIAL_SUPPLY");
    ...
    function _mint(address to, uint256 value) internal {
        require(to != address(0), "ERC20: MINT_TO_ZERO_ADDRESS");
    ...
    function _burn(address from, uint256 value) internal {
        require(from != address(0), "ERC20: BURN_FROM_ZERO_ADDRESS");
    ...
    function _approve(address owner, address spender, uint256 value) internal {
        ...
        require(spender != address(0), "ERC20: APPROVE_TO_ZERO_ADDRESS");
     ...
     * @dev Reduz o saldo do remetente e aumenta o do destinatário. Emite evento Transfer.
     *      Reverte se os endereços forem inválidos, o valor for zero ou o saldo for insuficiente.
     * @param from Endereço de origem.
     * @param to Endereço de destino.
     * @param value Quantidade de tokens a transferir.
     */
    function _transfer(address from, address to, uint256 value) internal {
        require(from != address(0), "ERC20: TRANSFER_FROM_ZERO_ADDRESS");
        require(to != address(0), "ERC20: TRANSFER_TO_ZERO_ADDRESS");
        require(value > 0, "ERC20: INVALID_TRANSFER_AMOUNT");
        require(balanceOf[from] >= value, "ERC20: INSUFFICIENT_BALANCE");
    ...
    /**
     * @notice Transfere tokens do chamador para um destinatário.
    ...
    /**
     * @notice Transfere tokens de um endereço autorizado.
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "ERC20: EXPIRED_DEADLINE");
        require(owner != address(0), "ERC20: INVALID_OWNER");
