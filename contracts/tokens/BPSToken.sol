 ...
 */
contract BPSToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    // ================================
    //           Constantes
    // ================================
     ...
     */
    constructor() ERC20("BANK PROJECT SOCIETY", "BPS") Ownable(msg.sender) {
        taxPercent = 1;
    ...
    function setTaxReceiver(address _receiver) external onlyOwner {
        require(_receiver != address(0), "BPSToken: INVALID_TAX_RECEIVER");
    ...
    function setTaxPercent(uint256 _taxPercent) external onlyOwner {
        require(_taxPercent <= MAX_TAX_PERCENT, "BPSToken: TAX_PERCENT_TOO_HIGH");
    ...
    function _transfer(
        ...
        require(sender != address(0), "BPSToken: TRANSFER_FROM_ZERO_ADDRESS");
        require(recipient != address(0), "BPSToken: TRANSFER_TO_ZERO_ADDRESS");
        require(amount > 0, "BPSToken: INVALID_TRANSFER_AMOUNT");
        require(taxReceiver != address(0), "BPSToken: TAX_RECEIVER_NOT_SET");
